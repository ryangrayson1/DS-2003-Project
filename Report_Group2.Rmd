...
**Hypothesis:** We hypothesize that higher weekend alcohol consumption will correlate with lower average total study time, but we do not expect to see a significant difference in the magnitude of correlation between males and females. 
...
ggplot(MathData, aes(x = Walc, y = studytime, color = sex))+
       ...
       scale_color_manual(breaks = c("F", "M"), 
                       values=c("orangered4", "mediumseagreen"))+
       labs(x= "Weekend Alcohol Consumption (1 = very low to 5 = very high)", y = "Study Time (hours per week)", title = "Relationship between Weekend Alcohol Consumption and 
